...
import { getPaymentsPageData }  from "@/lib/shop-cache";
...
export default async function PaymentsPage({ params }: Props) {
  ...
  const { payments, stats } = await getPaymentsPageData(shopId);

  return <PaymentsView activeShop={{ id: shop.id, name: shop.name, location: shop.location }} isAdmin={isAdmin} payments={payments} stats={stats} />;
}
