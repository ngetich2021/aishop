...
import { getReportsPageData }  from "@/lib/shop-cache";
...
export default async function ReportsPage({ params }: Props) {
  ...
  const { stats, dailyData, topProducts, payBreakdown } = await getReportsPageData(shopId);

  return <ReportsView activeShop={{ id: shop.id, name: shop.name, location: shop.location }} period="month" stats={stats} dailyData={dailyData} topProducts={topProducts} payBreakdown={payBreakdown} />;
}
